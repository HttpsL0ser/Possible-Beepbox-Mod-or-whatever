...
export class ChangeRmHzOffset extends ChangeInstrumentSlider {
    constructor(doc: SongDocument, oldValue: number, newValue: number) {
        super(doc);
        this._instrument.ringModHzOffset = newValue + Config.rmHzOffsetCenter;
        doc.notifier.changed();
...
export class ChangeFlangerVoices extends ChangeInstrumentSlider {
    constructor(doc: SongDocument, oldValue: number, newValue: number) {
        super(doc);
        this._instrument.flangerVoices = newValue;
        // doc.synth.unsetMod(Config.modulators.dictionary["..."].index, doc.channel, doc.getCurrentInstrument());
        doc.notifier.changed();
        if (oldValue != newValue) this._didSomething();
    }
...
export class ChangeFlangerPan extends ChangeInstrumentSlider {
    constructor(doc: SongDocument, oldValue: number, newValue: number) {
        super(doc);
        this._instrument.flangerPan = newValue;
        // doc.synth.unsetMod(Config.modulators.dictionary["..."].index, doc.channel, doc.getCurrentInstrument());
        doc.notifier.changed();
        if (oldValue != newValue) this._didSomething();
    }
...
export class ChangeFlangerFeedmix extends ChangeInstrumentSlider {
    constructor(doc: SongDocument, oldValue: number, newValue: number) {
        super(doc);
        this._instrument.flangerFeedmix = newValue;
        // doc.synth.unsetMod(Config.modulators.dictionary["..."].index, doc.channel, doc.getCurrentInstrument());
        doc.notifier.changed();
        if (oldValue != newValue) this._didSomething();
    }
...
export class ChangeColorizerMix extends ChangeInstrumentSlider {
    constructor(doc: SongDocument, oldValue: number, newValue: number) {
        super(doc);
        this._instrument.colorizerMix = newValue;
        // doc.synth.unsetMod(Config.modulators.dictionary["..."].index, doc.channel, doc.getCurrentInstrument());
        doc.notifier.changed();
        if (oldValue != newValue) this._didSomething();
    }
...
export class ChangeColorizerColor extends ChangeInstrumentSlider {
    constructor(doc: SongDocument, oldValue: number, newValue: number) {
        super(doc);
        this._instrument.colorizerColor = newValue;
        // doc.synth.unsetMod(Config.modulators.dictionary["..."].index, doc.channel, doc.getCurrentInstrument());
        doc.notifier.changed();
        if (oldValue != newValue) this._didSomething();
    }
...
export class ChangeColorizerChannel extends ChangeInstrumentSlider {
    constructor(doc: SongDocument, oldValue: number, newValue: number) {
        super(doc);
        this._instrument.colorizerChannel = newValue;
        doc.notifier.changed();
        if (oldValue != newValue) this._didSomething();
    }
}

export class ChangeColorizerMaxFreq extends ChangeInstrumentSlider {
    constructor(doc: SongDocument, oldValue: number, newValue: number) {
        super(doc);
        this._instrument.colorizerMaxFreq = newValue;
        doc.notifier.changed();
        if (oldValue != newValue) this._didSomething();
    }
}

export class ChangeColorizerMinFreq extends ChangeInstrumentSlider {
    constructor(doc: SongDocument, oldValue: number, newValue: number) {
        super(doc);
        this._instrument.colorizerMinFreq = newValue;
        doc.notifier.changed();
        if (oldValue != newValue) this._didSomething();
    }
}
...
export class ChangeVolume extends Change {
    constructor(doc: SongDocument, oldValue: number, newValue: number) {
        if(import.meta.env.PROD && DO_ALERTS) window.alert("THIS IS THE TESTING VERSION! ANY SONGS MADE HERE WILL BREAK! Go to https://laserbox.github.io/ for the non-testing version. (without the \"laserbox/dist/\" in the URL)");
        super();
...
export class ChangeSongTitle extends Change {
    constructor(doc: SongDocument, oldValue: string, newValue: string) {
        ...
        let newTitle = "";
		const tabTitleFormat = localStorage.getItem("customTabTitle") || `\\T - LaserBox \\V`;
