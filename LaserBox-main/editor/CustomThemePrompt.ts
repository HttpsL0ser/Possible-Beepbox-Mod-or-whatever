...
export class CustomThemePrompt implements Prompt {
	...
	private readonly _tabTitleInput: HTMLInputElement = input({ type: "text", value: localStorage.getItem("customTabTitle") || `\\T - LaserBox \\V`});
	...
	public readonly container: HTMLDivElement = div({ class: "prompt noSelection", style: "width: 300px;" },
        ...
        div(),
        p({ style: "text-align: left; margin: 0;" },
            "Alter the text below to change the tab title. Use \\T for song title, \\A for song author, \\D for song description, and \\V for LaserBox version:",
        ),
        this._tabTitleInput,
		div(),
        p({ style: "text-align: left; margin: 0;" },
