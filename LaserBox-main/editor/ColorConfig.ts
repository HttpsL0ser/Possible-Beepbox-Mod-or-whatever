...
export class ColorConfig {
	...
	public static readonly defaultTheme: string = "laserbox";
	...
	"dark classic": ``,
        ...
        "jummbox classic": `
		    ...
		    "nightfall": `
				:root {
					--page-margin: #14051a;
					--editor-background: #25102E;
					--playhead: rgba(255, 255, 255, 0.9);
					--primary-text: #FFEEB9;
					--secondary-text: #FFEEB9;
					--inverted-text: #13695e;
					--box-selection-fill: #a252a5;
					--loop-accent: #ff8ee6;
					--link-accent: white;
					--ui-widget-background: #492651;
					--ui-widget-focus: #7a4386;
					--pitch-background: #47224e77;
					--tonic: #ffedb9e5;
					--fifth-note: #b56fb375;
					--white-piano-key: #ffffff;
					--black-piano-key: #170515;
					--white-piano-key-text: #1f1120;
					--use-color-formula: true;
					--track-editor-bg-pitch: #4d1d49;
					--track-editor-bg-pitch-dim: #2d1738;
					--track-editor-bg-noise: #752a69;
					--track-editor-bg-noise-dim: #382144;
					--track-editor-bg-mod: #8d456f;
					--track-editor-bg-mod-dim: #4f2a57;
					--multiplicative-mod-slider: #3abb22;
					--overwriting-mod-slider: #71eee5;
					--indicator-primary: #a773e5;
					--indicator-secondary: #4c1c89;
					--select2-opt-group: #944b90;
					--input-box-outline: #18040a;
					--mute-button-normal: #ffe0a8;
					--mute-button-mod: #a773e5;
					--mod-label-primary: #a773e5;
					--mod-label-secondary-text: #6b29bf;
					--mod-label-primary-text: #14051a;
					--mod-title: #e970cb;
					--pitch-secondary-channel-hue: 300;
					--pitch-secondary-channel-hue-scale: 6.1;
					--pitch-secondary-channel-sat: 80.0;
					--pitch-secondary-channel-sat-scale: 0.15;
					--pitch-secondary-channel-lum: 70.0;
					--pitch-secondary-channel-lum-scale: 0.05;
					--pitch-primary-channel-hue: 300;
					--pitch-primary-channel-hue-scale: 6.1;
					--pitch-primary-channel-sat: 100;
					--pitch-primary-channel-sat-scale: 0.15;
					--pitch-primary-channel-lum: 79.0;
					--pitch-primary-channel-lum-scale: 0;
					--pitch-secondary-note-hue: 300;
					--pitch-secondary-note-hue-scale: 6.1;
					--pitch-secondary-note-sat: 75.0;
					--pitch-secondary-note-sat-scale: 0.15;
					--pitch-secondary-note-lum: 59;
					--pitch-secondary-note-lum-scale: 0.03;
					...
					--pitch-primary-note-lum: 85.6;
					--pitch-primary-note-lum-scale: 0.025;
					--noise-secondary-channel-hue: 330;
					--noise-secondary-channel-hue-scale: 2;
					--noise-secondary-channel-sat: 55;
					--noise-secondary-channel-sat-scale: 0;
					--noise-secondary-channel-lum: 72;
					--noise-secondary-channel-lum-scale: 0;
					--noise-primary-channel-hue: 330;
					--noise-primary-channel-hue-scale: 2;
					--noise-primary-channel-sat: 66;
					--noise-primary-channel-sat-scale: 0;
					--noise-primary-channel-lum: 63.5;
					--noise-primary-channel-lum-scale: 0;
					--noise-secondary-note-hue: 330;
					--noise-secondary-note-hue-scale: 2;
					--noise-secondary-note-sat: 85;
					--noise-secondary-note-sat-scale: 0;
					--noise-secondary-note-lum: 55;
					--noise-secondary-note-lum-scale: 0;
					--noise-primary-note-hue: 330;
					--noise-primary-note-hue-scale: 2;
					--noise-primary-note-sat: 70;
					--noise-primary-note-sat-scale: 0;
					--noise-primary-note-lum: 74;
					--noise-primary-note-lum-scale: 0;
					--mod-secondary-channel-hue: 301;
					--mod-secondary-channel-hue-scale: 1.5;
					--mod-secondary-channel-sat: 88;
					--mod-secondary-channel-sat-scale: 0;
					--mod-secondary-channel-lum: 70;
					--mod-secondary-channel-lum-scale: 0;
					--mod-primary-channel-hue: 301;
					--mod-primary-channel-hue-scale: 1.5;
					--mod-primary-channel-sat: 96;
					--mod-primary-channel-sat-scale: 0;
					--mod-primary-channel-lum: 80;
					--mod-primary-channel-lum-scale: 0;
					--mod-secondary-note-hue: 301;
					--mod-secondary-note-hue-scale: 1.5;
					--mod-secondary-note-sat: 92;
					--mod-secondary-note-sat-scale: 0;
					--mod-secondary-note-lum: 45;
					--mod-secondary-note-lum-scale: 0;
					--mod-primary-note-hue: 301;
					--mod-primary-note-hue-scale: 1.5;
					--mod-primary-note-sat: 96;
					--mod-primary-note-sat-scale: 0;
					--mod-primary-note-lum: 85;
...
--mod1-secondary-channel: #339955;
	...
	"axobox": `
		...
		:root {
			--page-margin: #0a0021;
			--editor-background: #0c0021;
			--hover-preview: #f8f2ff;
			--playhead: #fff;
			--primary-text: #fff;
			--secondary-text: #665475;
			--box-selection-fill: #3e0028;
			--loop-accent: #ae5efffc;
			--link-accent: #ff3ad5fc;
			--ui-widget-background: #381f51;
			--ui-widget-focus: #633891;
			--pitch-background: #432b54;
			--tonic: #89216a;
			--fifth-note: #792ab2;
			--white-piano-key: #432b54;
			--black-piano-key: #432b54;
			--white-piano-key-text: #81708e;
			--black-piano-key-text: #81708e;
			--track-editor-bg-pitch: #46336b;
			--track-editor-bg-pitch-dim: #1d1130;
			--track-editor-bg-noise: #4c2a4b;
			--track-editor-bg-noise-dim: #141414;
			--track-editor-bg-mod: #482d66;
			--track-editor-bg-mod-dim: #2a1640;
			--multiplicative-mod-slider: #7e5e9e;
			--overwriting-mod-slider: #8c4fb5;
			--indicator-primary: #ff8bd1;
			--indicator-secondary: #44384f;
			--select2-opt-group: #605770;
			--input-box-outline: #222;
			--mute-button-normal: #b750fc;
			--mute-button-mod: #f241b7;
			--pitch1-secondary-channel: #9b316f;
			--pitch1-primary-channel: #ff54b7;
			--pitch1-secondary-note: #ba4c8c;
			--pitch1-primary-note: #ff99c5;
			--pitch2-secondary-channel: #864daf;
			--pitch2-primary-channel: #cb84ff;
			--pitch2-secondary-note: #682e91;
			--pitch2-primary-note: #c068ff;
			--pitch3-secondary-channel: #018e8e;
			--pitch3-primary-channel: #3de4ff;
			--pitch3-secondary-note: #24b7b7;
			--pitch3-primary-note: #a7ffff;
			...
			--pitch5-secondary-note: #3e99d9;
			--pitch5-primary-note: #b3e3ff;
			--pitch6-secondary-channel: #903b93;
			--pitch6-primary-channel: #ff77ff;
			--pitch6-secondary-note: #dd4dd6;
			--pitch6-primary-note: #ffb2ff;
			--pitch7-secondary-channel: #4f007d;
			--pitch7-primary-channel: #a54cd9;
			--pitch7-secondary-note: #732b9d;
			--pitch7-primary-note: #d386ff;
			--pitch8-secondary-channel: #515899;
			--pitch8-primary-channel: #4f83ff;
			--pitch8-secondary-note: #3a60b2;
			--pitch8-primary-note: #a3beff;
			--pitch9-secondary-channel: #1f5b60;
			--pitch9-primary-channel: #68f2ff;
			--pitch9-secondary-note: #25838c;
			--pitch9-primary-note: #68f2ff;
			--pitch10-secondary-channel: #6D438C;
			--pitch10-primary-channel: #cc98f2;
			--pitch10-secondary-note: #8040B0;
			--pitch10-primary-note: #cb98f2;
			--noise1-secondary-channel: #635070;
			--noise1-primary-channel: #9071db;
			--noise1-secondary-note: #915dc1;
			--noise1-primary-note: #c5a5ff;
			...
			--noise4-secondary-note: #b871c1;
			--noise4-primary-note: #ffb8f0;
			--noise5-secondary-channel: #5c3777;
			--noise5-primary-channel: #9e77ba;
			--noise5-secondary-note: #9e77ba;
			--noise5-primary-note: #cfb3e2;
			--mod1-secondary-channel: #4e8397;
			--mod1-primary-channel: #92e6f3;
			--mod1-secondary-note: #76b9d9;
			--mod1-primary-note: #cde3ff;
			...
			--mod2-secondary-note: #c9719b;
			--mod2-primary-note: #fdcee7;
			--mod3-secondary-channel: #a83578;
			--mod3-primary-channel: #c62583;
			--mod3-secondary-note: #cc579b;
			--mod3-primary-note: #e8bbd5;
			--mod4-secondary-channel: #6f579f;
			--mod4-primary-channel: #b192f7;
			--mod4-secondary-note: #7c3fc8;
			--mod-label-primary: #3e2c56;
			--mod-label-secondary-text: rgb(96,69,147);
			--mod-label-primary-text: white;
			--disabled-note-primary: #91879f;
			--disabled-note-secondary: #71667a;
		}`,
	"azur lane":`
		:root {
			--page-margin: #19337e;
	...
	"laserbox": `
		:root {
			--page-margin: #050007;
			--editor-background: #050007;
			--hover-preview: #ffffff;
			--playhead: rgba(255,255,255,0.9);
			--primary-text: #f2eaff;
			--secondary-text: #7d5a99;
			--text-selection: rgba(255,0,170,0.99);
			--box-selection-fill: rgba(0,255,220,0.25);
			--loop-accent: #ff00aa;
			--link-accent: #00eaff;
			--ui-widget-background: #1a0d2e;
			--ui-widget-focus: #33184d;
			--pitch-background: #120a1f;
			--tonic: #ff2a6d;
			--fifth-note: #00ffd0;
			--white-piano-key: #f2eaff;
			--black-piano-key: #22112e;
			--use-color-formula: true;
			--track-editor-bg-pitch: #23103a;
			--track-editor-bg-pitch-dim: #150a24;
			--track-editor-bg-noise: #142238;
			--track-editor-bg-noise-dim: #0b1420;
			--track-editor-bg-mod: #2a0d2e;
			--track-editor-bg-mod-dim: #170717;
			--multiplicative-mod-slider: #ff5fc4;
			--overwriting-mod-slider: #5fe0ff;
			--indicator-primary: #00eaff;
			--indicator-secondary: #123a44;
			--select2-opt-group: #12081f;
			--input-box-outline: #12081f;
			--mute-button-normal: #ff00aa;
			--mute-button-mod: #7d1f8a;
			--mod-label-primary: #1c0d29;
			--mod-label-secondary-text: #7d5a99;
			--mod-label-primary-text: #00eaff;
			--disabled-note-primary: #5c4a75;
			--disabled-note-secondary: #241733;
			--pitch-secondary-channel-hue: 300;
			--pitch-secondary-channel-hue-scale: 9;
			--pitch-secondary-channel-sat: 80;
			--pitch-secondary-channel-sat-scale: 0.1;
			--pitch-secondary-channel-lum: 30;
			--pitch-secondary-channel-lum-scale: 0.05;
			--pitch-primary-channel-hue: 300;
			--pitch-primary-channel-hue-scale: 9;
			--pitch-primary-channel-sat: 100;
			--pitch-primary-channel-sat-scale: 0.1;
			--pitch-primary-channel-lum: 60;
			--pitch-primary-channel-lum-scale: 0.05;
			--pitch-secondary-note-hue: 300;
			--pitch-secondary-note-hue-scale: 9;
			--pitch-secondary-note-sat: 85;
			--pitch-secondary-note-sat-scale: 0.1;
			--pitch-secondary-note-lum: 35;
			--pitch-secondary-note-lum-scale: 0.05;
			--pitch-primary-note-hue: 300;
			--pitch-primary-note-hue-scale: 9;
			--pitch-primary-note-sat: 100;
			--pitch-primary-note-sat-scale: 0.05;
			--pitch-primary-note-lum: 75;
			--pitch-primary-note-lum-scale: 0.025;
			--noise-secondary-channel-hue: 185;
			--noise-secondary-channel-hue-scale: 4;
			--noise-secondary-channel-sat: 70;
			--noise-secondary-channel-sat-scale: 0;
			--noise-secondary-channel-lum: 30;
			--noise-secondary-channel-lum-scale: 0;
			--noise-primary-channel-hue: 185;
			--noise-primary-channel-hue-scale: 4;
			--noise-primary-channel-sat: 90;
			--noise-primary-channel-sat-scale: 0;
			--noise-primary-channel-lum: 55;
			--noise-primary-channel-lum-scale: 0;
			--noise-secondary-note-hue: 185;
			--noise-secondary-note-hue-scale: 4;
			--noise-secondary-note-sat: 75;
			--noise-secondary-note-sat-scale: 0;
			--noise-secondary-note-lum: 35;
			--noise-secondary-note-lum-scale: 0;
			--noise-primary-note-hue: 185;
			--noise-primary-note-hue-scale: 4;
			--noise-primary-note-sat: 95;
			--noise-primary-note-sat-scale: 0;
			--noise-primary-note-lum: 70;
			--noise-primary-note-lum-scale: 0;
			--mod-secondary-channel-hue: 350;
			--mod-secondary-channel-hue-scale: 3;
			--mod-secondary-channel-sat: 80;
			--mod-secondary-channel-sat-scale: 0;
			--mod-secondary-channel-lum: 40;
			--mod-secondary-channel-lum-scale: 0;
			--mod-primary-channel-hue: 350;
			--mod-primary-channel-hue-scale: 3;
			--mod-primary-channel-sat: 95;
			--mod-primary-channel-sat-scale: 0;
			--mod-primary-channel-lum: 65;
			--mod-primary-channel-lum-scale: 0;
			--mod-secondary-note-hue: 350;
			--mod-secondary-note-hue-scale: 3;
			--mod-secondary-note-sat: 85;
			--mod-secondary-note-sat-scale: 0;
			--mod-secondary-note-lum: 45;
			--mod-secondary-note-lum-scale: 0;
			--mod-primary-note-hue: 350;
			--mod-primary-note-hue-scale: 3;
