...
.obtrusive-scrollbars::-webkit-scrollbar-thumb:hover, .obtrusive-scrollbars *::-webkit-scrollbar-thumb:hover {
...
/* Compressor styles */
.beepboxEditor .compressorTitleContainer {
  font-weight: bold;
  text-align: center;
  cursor: pointer;
}
.beepboxEditor .compressorContainer {
  .selectRow > span:first-child {
 	  color: ${ColorConfig.secondaryText};
  }
  .compressorKnobContainer {
    display: grid;
    grid-template-columns: 1fr 1fr 1fr;
  }
  .compressorGainSliderContainer {
    display: grid;
    grid-template-columns: 1fr 1fr 1fr;
    margin-bottom: 1rem;
    > span { width: 100% }
